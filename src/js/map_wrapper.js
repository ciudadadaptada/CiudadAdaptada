...
AccesibleMap.accesible_icon = L.icon({
        iconUrl: '/CiudadAdaptada/images/accesible_marker.png',
...
//	AccesibleMap.mapa.locate({setView: false});
//	AccesibleMap.mapa.fitBounds([origen,destination]);
...
AccesibleMap.add_origen_current_loc = function(){
    ...
    $('#route-from').val("Posicion actual");
};
